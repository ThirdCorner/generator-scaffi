System.config({
  ...
  map: {
    ...
    "npm:collections@0.2.2": {
      "weak-map": "npm:weak-map@1.0.0"
    },
    "npm:colors@0.6.2": {
      "assert": "github:jspm/nodelibs-assert@0.1.0"
    },
    ...
    "npm:dgeni-packages@0.10.19": {
      "canonical-path": "npm:canonical-path@0.0.2",
      "catharsis": "npm:catharsis@0.8.8",
      "change-case": "npm:change-case@2.3.1",
      "dgeni": "npm:dgeni@0.4.2",
      ...
      "node-html-encoder": "npm:node-html-encoder@0.0.2",
      "nunjucks": "npm:nunjucks@1.3.4",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "q": "npm:q@1.0.1",
      "q-io": "npm:q-io@1.10.9",
      "semver": "npm:semver@4.3.6",
      "shelljs": "npm:shelljs@0.5.3",
      "stringmap": "npm:stringmap@0.2.2",
      "url": "github:jspm/nodelibs-url@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0",
      "winston": "npm:winston@0.7.3"
    },
    "npm:dgeni@0.4.2": {
      "canonical-path": "npm:canonical-path@0.0.2",
      "dependency-graph": "npm:dependency-graph@0.4.1",
      "di": "npm:di@0.0.1",
      "lodash": "npm:lodash@3.10.1",
    ...
    "npm:gulp-sequence@0.3.2": {
      "gulp": "npm:gulp@3.8.11",
      "gulp-util": "npm:gulp-util@3.0.7",
      "systemjs-json": "github:systemjs/plugin-json@0.1.2",
      "thunks": "npm:thunks@2.7.3"
    },
    "npm:gulp-util@3.0.7": {
    ...
    "npm:ng-table@0.8.3": {
      ...
      "child_process": "github:jspm/nodelibs-child_process@0.1.0",
      "dgeni": "npm:dgeni@0.4.2",
      "dgeni-packages": "npm:dgeni-packages@0.10.19",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "gulp": "npm:gulp@3.8.11",
      "gulp-sequence": "npm:gulp-sequence@0.3.2",
      "gulp-wait": "npm:gulp-wait@0.0.2",
    ...
    "npm:q-io@1.10.9": {
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "collections": "npm:collections@0.2.2",
      "fs": "github:jspm/nodelibs-fs@0.1.2",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "https": "github:jspm/nodelibs-https@0.1.0",
      "mime": "npm:mime@1.2.11",
      "mimeparse": "npm:mimeparse@0.1.4",
      "path": "github:jspm/nodelibs-path@0.1.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "q": "npm:q@0.9.7",
      "qs": "npm:qs@0.1.0",
    ...
    "npm:request@2.16.6": {
      "aws-sign": "npm:aws-sign@0.2.0",
      "buffer": "github:jspm/nodelibs-buffer@0.1.0",
      "cookie-jar": "npm:cookie-jar@0.2.0",
      "crypto": "github:jspm/nodelibs-crypto@0.1.0",
      "forever-agent": "npm:forever-agent@0.2.0",
      "form-data": "npm:form-data@0.0.10",
      "hawk": "npm:hawk@0.10.2",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "https": "github:jspm/nodelibs-https@0.1.0",
      "json-stringify-safe": "npm:json-stringify-safe@3.0.0",
      "mime": "npm:mime@1.2.11",
      "node-uuid": "npm:node-uuid@1.4.7",
      "oauth-sign": "npm:oauth-sign@0.2.0",
      "process": "github:jspm/nodelibs-process@0.1.2",
      "qs": "npm:qs@0.5.6",
      "querystring": "github:jspm/nodelibs-querystring@0.1.0",
      "stream": "github:jspm/nodelibs-stream@0.1.0",
      "tls": "github:jspm/nodelibs-tls@0.1.0",
      "tunnel-agent": "npm:tunnel-agent@0.2.0",
      "url": "github:jspm/nodelibs-url@0.1.0",
      "util": "github:jspm/nodelibs-util@0.1.0"
    },
    "npm:request@2.72.0": {
