System.config({
  ...
  paths: {
    ...
    "decorators": "src/app/core/ng-decorators",
    "app": "src/app"
  },
  buildCSS: false,

  map: {
    "ENV": "src/app/core/config/env.conditions",
    ...
    "npm:continuation-local-storage@3.1.6": {
      "assert": "github:jspm/nodelibs-assert@0.1.0",
      "async-listener": "npm:async-listener@0.5.6",
    ...
    "npm:karma@0.13.19": {
      ...
      "graceful-fs": "npm:graceful-fs@4.1.3",
      "http": "github:jspm/nodelibs-http@1.7.1",
      "http-proxy": "npm:http-proxy@1.13.1",
      "https": "github:jspm/nodelibs-https@0.1.0",
      "lodash": "npm:lodash@3.10.1",
